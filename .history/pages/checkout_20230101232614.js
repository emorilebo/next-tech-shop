...
export default function CheckoutPage() {
  ...
  return (
    <Layout>
      ...
      <div>
        <input className="bg-gray" type="text" placeholder="Street address, number" />
        <input className="bg-gray" type="text" placeholder="City and postal code" />
        <input className="bg-gray" type="text" placeholder="Email address" />
      </div>
    </Layout>
  );
}
