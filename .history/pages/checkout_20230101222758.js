        ...
        productsInfos.map((productsInfo) => (
          <div className="flex mb-5">
            ...
            <div className="pl-4">
                ...
                <button className="border border-orange-300 px-2 rounded-md text-orange-500">-</button>
                <div>{selectedProducts.filter(id=>id === productsInfo._id).length}</div>
                <button className="border bg-orange-300 border-orange-500 px-2 rounded-md text-white">+</button>
                </div>
              </div>
          </div>
        ))
